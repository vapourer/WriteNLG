...
public class PointYValueInverseComparatorTest
{
	...
	public static void setupClass()
	{
		...
		LOGGER = LogManager.getLogger("PointYValueInverseComparatorTest.class");
	}
	...
	public void testCompare_Equals()
	{
		...
		// Assert
		Assert.assertTrue(new PointYValueInverseComparator().compare(this.point1, point2) == 0);
	}
	...
	public void testCompare_NotEquals()
	{
		...
		// Assert
		Assert.assertFalse(new PointYValueInverseComparator().compare(this.point1, point2) == 0);
	}
