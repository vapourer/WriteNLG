...
/**
 * Represents the trend of the gap between series, after calculating a centred moving average.
 */
public class SeriesDifferencesTrendConcept extends AbstractConcept
{
	private final LineGraphWithDerivedInformation lineGraph;
	private final Map<String, ConstraintConfiguration> constraints;

	public SeriesDifferencesTrendConcept(List<PhraseSpecification> phraseSpecifications,
			final LineGraphWithDerivedInformation lineGraph)
	{
		...
		this.constraints = Constraints.getInstance()
				.getConstraintConfigurationsForGlobalConcept(GlobalConcept.SERIES_DIFFERENCES_TREND);
